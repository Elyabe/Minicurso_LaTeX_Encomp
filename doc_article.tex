...
%PREAMBULO
	...
	\usepackage[top=2cm, bottom=2cm, left=2.5cm, right=2.5cm]{geometry} %Dimensionar estilos da página
%	\usepackage{lscape} %Modo paisagem apenas num conteúdo
	\usepackage{pdflscape} %Modo paisagem também na paǵina 
	\usepackage{fancyhdr} %Cabeçalho estilizado
		\pagestyle{fancy}
...
%	Criando e Redefinindo comandos
	\newcommand{\novoComando}{\textbf{Novo} comando $\square$}
	\renewcommand{\bf}{\it}
	
\begin{document} 
%CORPO DO DOCUMENTO
	\lhead{\novoComando}
	\rhead{Cab. Direito \date }
	\chead{Cab. Central}
	\lfoot{Rod. Esquerdo}
	\rfoot{Rod. Direito}
