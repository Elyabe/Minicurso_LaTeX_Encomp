% Universidade Federal do Espirito Santos - Ceunes
% Algoritmos Numericos II - Trabalho final
...
% m in [0,1]
% G : Matriz Google
% tol_erro: Tolerancia para metodo das potencias
clear
clc
tol_erro = 1e-6;
m = 0.15;
...
% Gera vetor para pagina aleatoria
